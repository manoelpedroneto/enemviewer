<%@ include file="../header.jsp"%>
	...
	<form action="<c:url value="/visualizador/idade"/>" class="form-inline" method="post">
		<fieldset>
	...
	<c:if test="${list != null}">
	<fieldset>
			<legend><strong> ${uf.nome} </strong> com a quantidade de inscritos agrupados por <strong>Idade</strong></legend>
